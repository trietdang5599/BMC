...
class SetMaxPADPPConfig(ModelConfig):
...
class SetMaxPADPPConfigForRecommendation(SetMaxPADPPConfig):
    """
...
class SetMaxPADPPConfigForNegotiation(SetMaxPADPPConfig):
    """
...
class SetMaxPADPPConfigForEmotionalSupport(SetMaxPADPPConfig):
    """
