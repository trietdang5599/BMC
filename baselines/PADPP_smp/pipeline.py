...
class SetMaxPADPPPipeline(Pipeline):
    ...
    def execute(self):
        ...
        if self.model_config.test_phase:
            ...
            if self.model_config.run_online_eval:
                ...
                # we directly load the RL finetuning model for online evaluation
...
class SetMaxPADPPPipelineForRecommendation(SetMaxPADPPPipeline):
...
class SetMaxPADPPPipelineForNegotiation(SetMaxPADPPPipeline):
...
class SetMaxPADPPPipelineForEmotionalSupport(SetMaxPADPPPipeline):
