...
class ICLAIFPipelineForRecommendation(ICLAIFPipeline):
...
class ICLAIFPipelineForNegotiation(ICLAIFPipeline):
...
class ICLAIFPipelineForEmotionalSupport(ICLAIFPipeline):
...
class ICLAIFPipelineForPersuation(ICLAIFPipeline):
