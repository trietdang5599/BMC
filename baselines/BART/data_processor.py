from base.data_processor import DataProcessorForRecommendation, DataProcessorForGeneration
...
class BARTDataProcessorForRecommendation(DataProcessorForRecommendation):
...
class BARTTorchDatasetForRecommendation(BaseTorchDataset):
    """
    BARTTorch dataset for recommendation class
    """
    pass
