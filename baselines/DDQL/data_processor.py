...
class DDQLDataProcessorForRecommendation(DataProcessorForRecommendation):
...
class DDQLTorchDataset(BaseTorchDataset):
...
class DDQLDataProcessorForNegotiation(DataProcessorForNegotiation):
    """
...
class DDQLDataProcessorForEmotionalSupport(DataProcessorForEmotionalSupport):
    """
