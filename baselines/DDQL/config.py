...
class DDQLConfigForRecommendation(DDQLConfig):
    """
...
class DDQLConfigForNegotiation(DDQLConfig):
    """
...
class DDQLConfigForEmotionalSupport(DDQLConfig):
    """
