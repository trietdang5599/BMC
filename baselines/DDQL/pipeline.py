...
class DDQLPipelineForRecommendation(DDQLPipeline):
...
class DDQLPipelineForNegotiation(DDQLPipeline):
...
class DDQLPipelineForEmotionalSupport(DDQLPipeline):
