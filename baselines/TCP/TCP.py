...
from baselines.TCP.GAT import GraphAttenTransformer
from baselines.TCP.MemNet import UserMemory
from baselines.TCP.Planner import Planner
from baselines.TCP.utils import ACT, TPC
...
class TCP(nn.Module):
    ...
    def __init__(self, args):
        ...
        self.user_memnet = UserMemory(vocab_size=self.vocab_size,
                                      query_size=args.embed_dim, memory_size=args.embed_dim,
                                      max_hop=args.max_memory_hop,
    ...
    def topk_sampling(self,
        ...
        while True:
            ...
            if top_k > 0:
                next_token_logits = TopKLogitsWarper(top_k=top_k, filter_value=filter_value,
