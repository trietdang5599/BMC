...
class EnvelopeConfig(ModelConfig):
...
class EnvelopeConfigForRecommendation(EnvelopeConfig):
    """
...
class EnvelopeConfigForNegotiation(EnvelopeConfig):
    """
...
class EnvelopeConfigForEmotionalSupport(EnvelopeConfig):
    """
