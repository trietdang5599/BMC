...
class ProCOTPipelineForRecommendation(ProCOTPipeline):
...
class ProCOTPipelineForNegotiation(ProCOTPipeline):
...
class ProCOTPipelineForEmotionalSupport(ProCOTPipeline):
...
class ProCOTPipelineForPersuation(ProCOTPipeline):
