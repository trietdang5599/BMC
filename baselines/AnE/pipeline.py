...
class AnEPipelineForRecommendation(AnEPipeline):
...
class AnEPipelineForNegotiation(AnEPipeline):
...
class AnEPipelineForEmotionalSupport(AnEPipeline):
...
class AnEPipelineForPersuation(AnEPipeline):
