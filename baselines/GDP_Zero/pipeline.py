...
class GDPZeroPipeline(Pipeline):
...
class GDPZeroPipelineForRecommendation(GDPZeroPipeline):
...
class GDPZeroPipelineForNegotiation(GDPZeroPipeline):
...
class GDPZeroPipelineForEmotionalSupport(GDPZeroPipeline):
