...
class RTCPDataProcessorForRecommendation(DataProcessorForRecommendation):
...
class RTCPDataProcessorForNegotiation(DataProcessorForNegotiation):
...
class RTCPDataProcessorForEmotionalSupport(DataProcessorForEmotionalSupport):
...
class RTCPTorchDatasetForRecommendation(BaseTorchDataset):
    """
...
class RTCPTorchDatasetForNegotiation(BaseTorchDataset):
    """
...
class RTCPTorchDatasetForEmotionalSupport(BaseTorchDataset):
    """
    class RTCP torch dataset for the negotiation scenario
    """
