...
class RTCPPipelineForRecommendation(RTCPPipeline):
...
class RTCPPipelineForNegotiation(RTCPPipeline):
...
class RTCPPipelineForEmotionalSupport(RTCPPipeline):
