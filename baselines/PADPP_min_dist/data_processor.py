...
class MinDistPADPPDataProcessorForRecommendation(DataProcessorForRecommendation):
...
class MinDistPADPPTorchDataset(BaseTorchDataset):
...
class MinDistPADPPDataProcessorForNegotiation(DataProcessorForNegotiation):
    """
...
class MinDistPADPPDataProcessorForEmotionalSupport(DataProcessorForEmotionalSupport):
    """
