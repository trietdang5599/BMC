...
class MinDistPADPPPipeline(Pipeline):
...
class MinDistPADPPPipelineForRecommendation(MinDistPADPPPipeline):
...
class MinDistPADPPPipelineForNegotiation(MinDistPADPPPipeline):
...
class MinDistPADPPPipelineForEmotionalSupport(MinDistPADPPPipeline):
