...
class DPDPPipelineForRecommendation(DPDPPipeline):
    ...
    def load_pretrained_model(self, is_rl=False, is_last=False):
        ...
        # this is the path for the rlt model
            ...
            saved_model_path = os.path.join(self.model_config.saved_dir, f"rl_model_{self.model_config.prioritized_objective}_{self.model_config.domain}.pth")
    ...
    def run_rlt(self, dev_ratio=0.2):
        ...
        train_items, dev_items = train_test_split(dev_target_items, 
                                                  test_size=dev_ratio,
...
class DPDPPipelineForNegotiation(DPDPPipeline):
...
class DPDPPipelineForEmotionalSupport(DPDPPipeline):
